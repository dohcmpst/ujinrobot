...
void CpuStartUserProgram(void)
{
  ...
  if (NvmVerifyChecksum() == BLT_FALSE)
  {
    ...
    /*  Debug Message */
    {
        Debug_Message("CpuStartUserProgram;()\n");
        Debug_Message(" --> if (NvmVerifyChecksum() == BLT_FALSE) \n");
  ...
  if (CpuUserProgramStartHook() == BLT_FALSE)
  {
    ...
    Debug_Message("CpuUserProgramStartHook() == BLT_FALSE\n");
    return;
  }
#endif
  ...
  Debug_Message("NvmVerifyChecksum() is Good !!\n");
  Debug_Message("Jump to Main() \n\n");
