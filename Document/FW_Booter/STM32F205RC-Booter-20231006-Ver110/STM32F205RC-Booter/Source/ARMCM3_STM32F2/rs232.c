...
****************************************************************************************/
#include "boot.h"  
/* bootloader generic header          */

#if ( (BOOT_COM_RS232_ENABLE > 0) || (BOOT_DEBUG_UART_ENABLE > 0) )
...
#define USART_CHANNEL   USART6                  // dnaprk
...
void Rs232Init(void)
{
  ...
  USART_InitStruct.BaudRate = BOOT_COM_RS232_BAUDRATE;  //921600;   //BOOT_COM_RS232_BAUDRATE;
...
#if (BOOT_DEBUG_UART_ENABLE > 0)    // dnpark, for Debugging
/************************************************************************************//**
...
//static blt_int8u testCanDataR[8] = { 1, 2, 3, 4, 5, 6, 7, 8 };

void Test_FFF(blt_int8u data)
{
      Rs232TransmitByte(data);
    
}


#endif /* BOOT_DEBUG_UART_ENABLE > 0 */
