...
//#define ADS1115_MAX_CHANNEL 1

#define Accuracy 32768 //ADC Single ended input 15 Bit accuracy
//#define ADS1115_ADDRESS_GND 0x90 //ADDR PIN ->GND SLAVE ADDRESS 01001000  Move left when sending 1
...
typedef enum
{
	...
	ADS1115_ADDRESS_GND			=	0x90,   //LAVE ADDRESS 01001000  Move left when sending 1
...
typedef enum
{
  ...
  ADS1115_CHANNEL0 = 0U,      //ADC passageway 0 rank 1
  ADS1115_CHANNEL1,           // passageway  1
	ADS1115_CHANNEL2,          // passageway  2
	ADS1115_CHANNEL3,          // passageway  3
	ADS1115_MAX_CHANNEL
